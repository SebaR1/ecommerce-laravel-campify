    ...
    @foreach ($productos as $meGusta)
        <div class="row border align-items-center">
            ...
            <div class="botonMeGusta col-2 text-center">
                <form method="POST" action="{{ route('me-gusta.destroy', ['producto_id' => $meGusta->producto_id]) }}">
                    @csrf
                    <button type="submit" class="btn_meGusta d-flex justify-content-center align-items-center btn_corazonRoto">
...
<div id="tarjetasMeGustas" class="row d-flex justify-content-center align-items-center mx-2">
    @foreach ($productos as $meGusta)
    <div class="col-12 col-sm-6 col-lg-4 mb-4 d-flex justify-content-center align-items-center mt-5">
            ...
            <div class="container_datos_tarjeta">
                ...
                <div class="d-flex justify-content-evenly align-items-center">
                    <div class="botonMeGusta me-1">
                        <form method="POST" action="{{ route('me-gusta.toggle', ['producto_id' => $meGusta->producto_id]) }}">
                            @csrf
                            <button type="submit" class="btn_meGusta d-flex justify-content-center align-items-center btn_corazonRoto">
                                <i class="fa-solid fa-heart-crack"></i>
                            </button>
